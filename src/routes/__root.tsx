...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Power your home, lower your bills, protect your future. MCS-certified solar PV and battery storage installation across the UK. Book your free survey today." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0D2B45" },
      { name: "twitter:title", content: "Apex Aims Grants Ltd — Solar Panels & Battery Storage UK" },
      { name: "twitter:description", content: "Power your home, lower your bills, protect your future. MCS-certified solar PV and battery storage installation across the UK. Book your free survey today." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/bb7cb1c6-e64f-49ca-981b-127085ef48f5/id-preview-2b3eb2fe--56b6e373-1f7b-45da-b082-cd6b3a117673.lovable.app-1783105050487.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/bb7cb1c6-e64f-49ca-981b-127085ef48f5/id-preview-2b3eb2fe--56b6e373-1f7b-45da-b082-cd6b3a117673.lovable.app-1783105050487.png" },
    ],
    links: [
